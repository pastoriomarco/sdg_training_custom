...
# CUSTOM_ASSET_PATHS=/home/tndlux/Downloads/source/your_object.usd WAREHOUSE_ROBOT_CONFIG=/isaac-sim/custom_sdg/warehouse_robots.default.yaml ./custom_datagen.sh
set -euo pipefail
